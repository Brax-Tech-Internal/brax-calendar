...
> **Brax fork.** Adds the `braxcal://` links and the tool registry the Brax chat app uses to open days, events and drafts from agent cards. See [docs/BRAX.md](docs/BRAX.md). Everything below is upstream.
